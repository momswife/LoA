...
**Date of Filing:** **23rd Cycle, 3102 A.D.**  
...
- Priority descent scheduling
    
- Emergency breach access
    
- Waived waiting periods
    
- Accelerated reclassification briefings
...
- Provide enhanced resonance tracking
    
- Allow non-standard movement within unstable floors
    
- Relay Core pings directly to the N-Class team
...
- Standard hazard role assignment
    
- Traditional formation mandates
...
- **DIV-class labyrinths** with active deity-linked hazards
    
- **EXL-class sites** experiencing temporal instability
    
- **CRB-class zones** with active corruption blooms
    
- **ANC-class ancestral vaults** typically locked to specific clans
...
- Two or more Divine Oculi
    
- A dedicated Arcanet Auditor
    
- The Structural Cartography Office
    
- The Charter Counsel Office (in cases of legal deviation)
    

Their actions often influence future labyrinth classification policy.
...
> _“When the Core selects, the Ministry recognizes. When the Core directs, the Ministry yields.”_

N-Class Teams therefore occupy a unique legal state:  
**both bound by the law and empowered to operate beyond it,  
